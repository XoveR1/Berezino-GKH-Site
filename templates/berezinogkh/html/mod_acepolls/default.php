...
<div class="module <?php echo $params->get('moduleclass_sfx'); ?>" style="border:none; padding:1px;">
 <?php if ($module->showtitle): ?>
        <h3><?= $module->title ?></h3>
    <?php endif; ?>
    
<?php if ($params->get('show_poll_title')) : ?>
    <p class="question"><?php echo $poll->title; ?></p>
<?php endif; ?>
    
<div class="content" id="polldiv_<?php echo $poll->id;?>">
...
<?php for ($i = 0, $n = count($options); $i < $n; $i ++) { ?>
	...
	<button type="submit" <?php echo $disabled; ?> id="submit_vote_<?php echo $poll->id; ?>" name="task_button" class="button">
            <span><?php echo JText::_('MOD_ACEPOLLS_VOTE'); ?></span>
        </button>
	</div>	
